        ...
        <section>
            <div class="signinpanel">
                <div class="row">
                    <div class="col-md-6">
                        <div class="signin-info">
                            ...
                            <h5><strong>Welcome to ...</strong></h5>
                            <ul>
                                <li><i class="fa fa-arrow-circle-o-right mr5"></i> Access for Admin</li>
                            </ul>
                        </div><!-- signin0-info -->
                    </div><!-- col-sm-7 -->
                ...
                <div class="signup-footer">
                    <div class="pull-left">Copyright @ Null Computindo</div>
                </div>
            </div><!-- signin -->
        </section>
