...
class Slider extends RAST_Control {
    ...
    function index() {
        ...
        , 'dataTable' => $this->M_slider->get_list()
        , 'add_button' => true
        , 'back_button' => false
        );

        $this->set_page('slider', $isi['descript'], 'slider', $isi);
    }
    ...
    function form() {
        ...
        $id = $_POST['id'];
        echo json_encode($this->M_slider->get_isi($id));
    }
